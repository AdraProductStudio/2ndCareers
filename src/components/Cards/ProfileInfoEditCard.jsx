                    ...
                    <p className="ms-5 mt-3 profile-descriptions">
                        {/* {cardDescription} */}
                        {
                            content !== '' && EditIcon ?
                                <p>{content}</p>
                            :
                                <textarea  className="w-100 p-3 textarea" value={content} rows={4} placeholder="Share with potential employers about your job preferences..." onChange={handleTextAreaChange}></textarea>
                        }
